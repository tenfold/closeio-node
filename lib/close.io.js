...
var Closeio = function(api_key){
    ...
    this.activity = {
        ...
        email: {
            ...
            read: function(id) {
                return closeio._get("/activity/email/" + id + "/");
            },
            update: function(id, options){
        ...
        call: {
            ...
            create: function (options) {
                return closeio._post("/activity/call/", options);
            },
            read: function (id) {
                return closeio._get("/activity/call/" + id + "/");
            },
            update: function (id, options) {
                return closeio._put("/activity/call/" + id + "/", options);
            },
            delete: function (id) {
